...
- **Effect**
  ...
  - Screen logic that uses only essential attributes will still function normally.
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/d2303b6ac62df96b4b7bb237f01cca5dec24d0c525899a9d9eac2ff07d61b2c3-image.png",null,"Note: if an audience only relies on `essential` user attributes, it will still be possible for a user with Processing #3 revoked to match it"],"align":"center"}]}[/block]
