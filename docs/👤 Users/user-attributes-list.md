...
[block:parameters]
{
  "data": {
    ...
    "0-2": "",
    "1-0": "**Device type**",
    "1-1": "The user device type. It will be one of the following: **_Phone, Pad, TV, Computer, Car_ **and** unknown**.",
    "1-2": "",
    "2-0": "**Language**",
    "2-1": "This parameter is generally defined at the device level, but can be overriden at the app level in the phone settings.  \nApp language: **_en,fr,ja_**.",
    "2-2": "",
    "3-0": "**Store Country**",
    "3-1": "User iOS store country:  \n  \n**JPN,USA,RUS**.",
    "3-2": "Only for iOS for SDK versions \\< 4.4.0.  \n  \niOS & Android for SDK versions ≥ 4.4.0 ",
    "4-0": "**Store name**",
    "4-1": "App store name: _**Apple App Store, Google Play Store**_.",
    "4-2": "",
    "5-0": "**OS version**",
    "5-1": "User device OS version Eg: 17.3.1.",
    "5-2": "",
    "6-0": "**SDK version**",
    "6-1": "Purchasely SDK version Eg: 4.2.1.",
    "6-2": "",
    "7-0": "**Anonymous id**",
    "7-1": "If the user didn't create an account, Purchasely creates anonymous id.  \nThis attribute is meant to be used rather for testing purposes to target a specific anonymous user.",
    "7-2": "",
    "8-0": "**User id**",
    "8-1": "User id assigned by the application. It's created when the user creates an account in your application.",
    "8-2": "",
    "9-0": "**Is logged in**",
    "9-1": "If the user has already created an account in your app or not.",
    "9-2": "",
    "10-0": "**Country(IP)**",
    "10-1": "User location country determined from the IP address.",
    "10-2": "",
    "11-0": "**Cumulated revenue in USD**",
    "11-1": "The cumulated revenue for expired and active subscription. The currency is in dollars only.",
    "11-2": "4.4.0"
  },
  "cols": 3,
  "rows": 12,
...
[block:parameters]
{
  "data": {
    ...
    "1-2": "4.2.0",
    "2-0": "**Number of paywalls / screens dismissed**",
    "2-1": "Total number of paywalls or other screens (created in Purchasely paywall builder) was closed by the user.",
    "2-2": "4.2.0",
    "3-0": "**Number of paywalls / screens displayed**",
    "3-1": "Total number of paywalls or other screens(created in Purchasely paywall builder) was displayed to the user.",
    "3-2": "4.2.0",
    "4-0": "**Last app session date**",
    "4-1": "It is the latest date and time there was an activity in the application.",
    "4-2": "4.2.0",
    "5-0": "**Last paywall / screen dismissed**",
    "5-1": "Its the latest paywall screen that was closed by the user.",
    "5-2": "4.2.0",
    "6-0": "**Last paywall / screen dismissed date**",
    "6-1": "Its the date and time latest paywall screen that was closed by the user.",
    "6-2": "4.2.0",
    "7-0": "**Last paywall / screen displayed**",
    "7-1": "Its the latest paywall screen that was displayed to the user.",
    "7-2": "4.2.0",
    "8-0": "**Last paywall / screen displayed date**",
    "8-1": "Its the date and time latest paywall screen that was displayed to the user.",
    "8-2": "4.2.0",
    "9-0": "**Last paywall converted**",
    "9-1": "It is the paywall from which user started their subscription or trial.",
    "9-2": "4.2.0",
    "10-0": "**Last placement converted**",
    "10-1": "It is the placement from which user started their subscription or trial.",
    "10-2": "4.2.0",
    "11-0": "**Last placement displayed**",
    "11-1": "It's the latest placement that was displayed to the user.",
    "11-2": "4.2.0"
  },
  "cols": 3,
  "rows": 12,
