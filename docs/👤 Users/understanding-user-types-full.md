...
- have created an account on the **App Store** with one email [email_1@my_provider.com](mailto:email_1@my_provider.com).
- have created an account on **your application** with another email [email_2@my_provider.com](mailto:email_2@my_provider.com) (which corresponds, for example, to the user with the ID 12345 in your database).
...
- Store: (email=[email_1@my_provider.com](mailto:email_1@my_provider.com))
- Application: (id=12345, email=[email_2@my_provider.com](mailto:email_2@my_provider.com))
- Purchasely: (id=12345)
