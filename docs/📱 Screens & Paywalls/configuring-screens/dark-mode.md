...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/85cc9b2-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/25d35f7-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]{"images":[{"image":["https://files.readme.io/1262e33-image.png",null,null],"align":"center","border":true}]}[/block]
...
1. Select your light mode paywall and click 'edit'.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/6f1cc70-image.png",null,""],"align":"center","border":true}]}[/block]
2. Switch to the 'Dark mode' tab

   [block:image]{"images":[{"image":["https://files.readme.io/72b935b-image.png",null,""],"align":"center","border":true}]}[/block]
3. Update it for dark mode: 
   ...
   4. Button text color, button background, border
      ...
      [block:image]{"images":[{"image":["https://files.readme.io/44b00d0-image.png",null,""],"align":"center","border":true}]}[/block]
