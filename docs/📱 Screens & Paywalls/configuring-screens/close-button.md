...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6a9c648-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ff4308a-Screen_Recording_2024-06-18_at_13.39.24.gif",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c04bc4d-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0e805b3-image.png",
        null,
        ""
      ],
      "align": "center",
...
1. `Leading`: This sets the close button:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/b084fc7-image.png",null,""],"align":"center","border":true}]}[/block]
2. `Trailing`: This sets the close button:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/4754f9a-image.png",null,""],"align":"center","border":true}]}[/block]
3. `Center`: This sets the close button to the center in the screen. 

   [block:image]{"images":[{"image":["https://files.readme.io/9747212-image.png",null,""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cf00ca7-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c1964be-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6069885-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1de06ae-image.png",
        null,
        ""
      ],
      "align": "center",
...
1. `Leading`: The icon followed by the label
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/5346e4d-image.png",null,""],"align":"center","border":true}]}[/block]
2. Trailing: The label followed by the icon

   [block:image]{"images":[{"image":["https://files.readme.io/26b9e92-image.png",null,""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/255bf0f-image.png",
        null,
        ""
      ],
      "align": "center",
