...
* **Layout**:
  ...
  * `Full width`: 
    ...
    * when disabled, you can manually set the `Width` of the CTA
      ...
      <Image align="center" src="https://files.readme.io/9ebbf977ee5f56fae548d335ee9557945b119d24f9fd695a308db766548f2f98-cta_validation.gif" />
...
* **Styles**:
  ...
  * You can define 2 different `background` and `border` for the CTA depending on its state: `active` / `disabled`
    ...
    <Image align="center" src="https://files.readme.io/e670fce11066c9da222f2de34dea5195330435b7d215a9350165f68a87e21110-cta_validation_styles.gif" />
