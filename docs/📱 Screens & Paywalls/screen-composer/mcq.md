...
<Image align="center" className="border" width="400px" border={true} src="https://files.readme.io/c6df64d06e9e25237316f3fdfc794b189d4e0e08e96710ae279eb798fc6b7584-image.png" />
...
<Image align="center" className="border" width="0px" border={true} src="https://files.readme.io/a8f30e6dc9409c3c5f39fb85fd3534f2a3dd02a7ac8da30daf590356fd1bb814-image.png" />
...
<Image align="center" className="border" width="400px" border={true} src="https://files.readme.io/5500643dc1ec672a141e5d9cbb7e9f65e4a9c43eadff92a0c896c806f493c674-image.png" />

Here are the parameters that can be configured:

<Image align="center" className="border" width="400px" border={true} src="https://files.readme.io/2045de8021f4c0eb199f92cc56e151b7cf25d71096a9ed15fbf5aef5b9239571-image.png" />
...
> 📘 Attributes for multiple answers
>
> If you enable the parameter "Allow multiple" and want to store the answers in an attribute, then the type of this attribute should be "Array of Strings"
>
> ![](https://files.readme.io/ea58fba0490ae8e793511dea9ece3b9c487ace607b66d4d3b1afef3a2364753e-image.png)

<br />

#### Screen behavior depending on survey configuration

<Image align="center" className="border" border={true} src="https://files.readme.io/f844ad1dacdefaa76d260f78dec5a105800651b6b07215b53f90d33faf203ee9-sample_survey_2.gif" />

<Image align="center" className="border" border={true} src="https://files.readme.io/87e6cb3f49fbf7db92e22c2d0296955754418c88c6c126af9c4c68c35625d765-sample_survey_1.gif" />
...
* The `Value` is used for tracking the Answers provided by the users and segmenting them.\
  *2 users with different locales, choosing the same answer submit the same value.*
  ...
  <Image align="center" className="border" border={true} src="https://files.readme.io/3055148d81c3f968891410b90ba14495713c287aa81831ca13e5bbca9b78ab55-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/d21542556d7262dc77bd06a4de8a6b3ad5b2a38b0da343bd9bd5b2f38d924abe-image.png" />
...
* **Layout**:
  ...
  * `Full width`: 
    ...
    * when disabled, you can manually set the `Width` of the CTA
      ...
      <Image align="center" className="border" border={true} src="https://files.readme.io/9ebbf977ee5f56fae548d335ee9557945b119d24f9fd695a308db766548f2f98-cta_validation.gif" />
...
* **Styles**:
  ...
  * Note that at the level of the Answer, it is possible to define if it should be selected by default or not
    ...
    <Image align="center" className="border" border={true} src="https://files.readme.io/81d08f24eeceee8504b01eeb51f731d055d08cd44139bbc728e991b6908b8f64-image.png" />
