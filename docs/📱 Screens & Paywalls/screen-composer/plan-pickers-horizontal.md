...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f4f00cf804668e0cd8931d456f3b9c3fcc3e96d95d392d7edf4805ae9dad3f03-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2160d23d2a114fda1212215dcdf34e516edf1d22e643e31093a5f6b941a6ce98-image.png",
        null,
        ""
      ],
      "align": "center",
...
- `Plan picker id`: the default value "plan_picker_1" works fine. Only change it if you want to have several Plan pickers on the same Screen:
...
- **Picker styles**
  ...
  - You can define 2 different `background` and `border` for each picker depending on its state: `unselected` / `selected`
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/bc4f2b08bbbadf7e7b29479ee3e12cbc5af0e1954bedb1ced2a6dea9f3e72965-selected_unselected.gif","",""],"align":"center","border":true}]}[/block]
...
- **Pickers layout**
  ...
  - `Scrollable`: If you want the picker to be scrollable horizontally and overflow from the Screen, you can enable this switch. In this case, you will need to define the `Width` for the pickers
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/074dcfa19855ae2beef851165d7f97e28ec3e54511bbea0ac0f64c30a91dbc05-image.png",null,""],"align":"center","border":true}]}[/block]
  - `Pickers per row`: you can define the number of pickers per row. If the number of pickers is superior to the number of pickers per row, a new row of pickers will be created below.
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/f3deb8814884d4764efb7d2c0d7debdf5aa5b2cfb7ebb0e4ff20f56c588281f4-horizontal.gif","",""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/699b637d2f04b8464a232f2a4b65ccd4b32e96f508a5f4f2fc8da40c0fe683ac-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ed9cd4b9d68393da5b5b7e14fef75a3c7e9581525ad62a6eb4d0e7d633f07518-picker_horizontal.gif",
        "",
        ""
      ],
      "align": "center",
...
To give you maximum flexibility and allow you to create as many lines and font-styles as you wish, each Picker has a _collection of Texts_ (ex: Promo label, Text inside button...). [Texts](texts) can be added inside a collection by clicking on the `+` button:

- Each collection maps a specific location

  [block:image]{"images":[{"image":["https://files.readme.io/143721814ff5afa8c102573cf8cd1feb8dd07d90cbfcaf1d82d06bb4b90c87d4-ezgif-6-295dcc5b43.gif","",""],"align":"center","border":true}]}[/block]
...
- This Text is overridden for each picker: 
  ...
  - "Start my **yearly** membership" for the Picker associated to the Yearly Plan
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/54bc1fc2116dad90e15ff4bddb30b9e244a4a60063f76cae1aeb9317130358cd-ezgif-6-28e9888568.gif","",""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c9cf149720193d6c698be56999788e3d3ca259b4aabb39652f36153c3a572c7e-promo_label_2.gif",
        "",
        ""
      ],
      "align": "center",
