...
1. associated directly to the screen as standalone elements
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/c1e3d8dbff7a96e3dd8b8b2ae1bf25b99776c143f87cb485798f6ff4164d4ae3-add_new_label_stand_alone.gif",null,""],"align":"center","border":true}]}[/block]
2. or added as sub-elements of a component by clicking on the + button in the structure of the component

   [block:image]{"images":[{"image":["https://files.readme.io/78d8c953b949a972a0c5270697bc7d7af7d1ec5b96ffe3a2b99ab0ec53149289-add_new_label_sub_element.gif",null,""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a3f77732b535b3d3abb9926f580443a90c90fd698cc0312bef09eabf398d000a-image.png",
        null,
        ""
      ],
      "align": "center",
...
- Within a Text, different text decorations can be applied (**Bold**, _Italic_, ~~Strike-through~~) and links can be inserted (web URL or deeplink)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/725b1f13d7d1f79340af35aee83919960a967cd80bc9df6486be57e5665bf8ab-image.png",
        null,
        "Style applied to the Text when the parent picker is `unselected`"
      ],
      "align": "center",
      "border": true,
      "caption": "Style applied to the Text when the parent picker is `unselected`"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/92d23e0efe02823013b6bcc4b260c9645363435ed0c67e566b607f0567b5240b-image.png",
        null,
        "Style applied to the Text when the parent picker is `selected`"
      ],
      "align": "center",
      "border": true,
      "caption": "Style applied to the Text when the parent picker is `selected`"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b4a1033f98b8fa89f14e2269d91dee106bd933a2f1439a073303cda183ab9bf8-image.png",
        null,
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/92b5924cb8469dbb366882929eba5466fc16aa310006aa23e46557ff2aae725b-ezgif-5-a9e3df5d72.gif",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1464c6c8ae60768410ea6c6de087b71d6af1d67b5350ff4bf5a2813c72d666b0-labels_bg.gif",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/15617a1ac5247b9e221fb527802376c1246f526f7aa300b94f0930f26dc0c954-action.gif",
        "",
        ""
      ],
      "align": "center",
