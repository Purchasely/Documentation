---
title: Carousel
excerpt: This section provides details on carousel configuration in the screen composer
deprecated: false
hidden: false
metadata:
  title: ''
...
1. **Settings**: You can set the carousel slide to auto play, set the pause timer and if you want to infinitely loop it. 
2. **Layout**: You can modify the height, mention the position of the texts in the carousel. With the full width tiles off, you can set the space between the slides and peak offset of the slides. 
