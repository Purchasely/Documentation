...
<Callout icon="⚠️" theme="warn">
  **Important**
  ...
  Safe Areas requires `Purchasely.display()` or `presentation.display()` to work correctly.  
  If your app uses a custom display method, safe area margins must be handled by the app itself.  
  Note that QR Code preview uses by default the standard method, so it will render correctly regardless of your integration.
</Callout>
...
<Image align="center" border={true} src="https://files.readme.io/ea0cb182a038f413edceddac8bdaba29439544a81320c8534ff800b04f1783c6-ScreenRecording2025-10-15at16.28.30-ezgif.com-video-to-gif-converter.gif" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/e195f76fb7f7298280712f5d0abb0d40ca5677d72d33e8059180ebf02d4b99de-ScreenRecording2025-10-15at17.30.56-ezgif.com-video-to-gif-converter.gif" className="border" />
...
<Image align="center" border={true} width="700px" src="https://files.readme.io/b80ac5996e8acb4facb51b08964355788303b05b728eb8a33cef62161108581b-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/f45e8e846297fe6af5a7eaffb35821ccbc06aa3d5c42ee9d4d4a5d7f5f2d9d84-image.png" className="border" />
