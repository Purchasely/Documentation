...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/64ee3ec771dd56987c606bfd90752883119b7b0ec82926dfcf3da37b4e6f39e3-Screen_Recording_2025-02-05_at_14.47.06-2.gif",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a9ec3a54ae0efd0d47cdf963642b699b03f66df84a75042c1a3ac6a2ddd831d6-Screen_Recording_2025-02-05_at_15.17.28.gif",
        "",
        ""
      ],
      "align": "center",
...
This feature consists in leveraging a CSV file containing a set of keys used in your different Screens across the entire application (in lines) and associate each key with a set of translations in all the languages managed by the application (in columns)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1ca5fe3dc21c5dc39f25d1541c92f2395c62eb2b76659c10740b59f1152a3e37-image.png",
        null,
        "Sample CSV file for Smart Localization"
      ],
      "align": "center",
      "border": true,
      "caption": "Sample CSV file for Smart Localization"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8c1c5d6f98931693de54d151a1a1123ceed50228f5df726e66ea7c03677881fe-image.png",
        null,
        null
      ],
      "align": "center",
...
To make a text italicized, you will need to use an underscore before and after the text. For example, _your text_ 
...
To add a hyperlink to a text, you will need to use the following format: [your text] \(HTTPS URL). For example, [purchasely] \(<https://www.purchasely.com/>) will appear as purchasely in the final output. Make sure to include the HTTPS URL within parentheses and remove any spaces between the text and the URL.
...
1. The template CSV file can be downloaded from the [App settings > Screen](https://console.purchasely.io/settings?step=screens) section in the Purchasely Console.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/b22ff885dbe0ce19f34ff593f93d8db10887b6b8bdcb0b59f9e0a1ffcd792f55-image.png",null,""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/85e25af382b69a713fab5400de7797beaebbc263fae16d6fe5f14e87ecc5279c-Screen_Recording_2025-02-12_at_13.03.17.gif",
        "",
        ""
      ],
      "align": "center",
...
You can then go over each Text element of your Screen an map it with the desired key from the translation file.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8e62d2dc5ec0bd24c5a9749e8f07753471eb3d18d87e6a3df2db27c7a59af357-smart.gif",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2effc466604086c54caa0cb859b087f7cea3f1643750941ea5358ca49b6b94a7-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/732de959ed806535d78510dbb43e3d983c8dc38dcd222fcd56df894e03412570-ScreenRecording2025-02-24at16.52.41-ezgif.com-video-to-gif-converter.gif",
        "",
        ""
      ],
      "align": "center",
