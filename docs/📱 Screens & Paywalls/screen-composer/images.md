...
* either you upload it by clicking on the **upload** link or drag and dropping the file in the appropriate zone
  ...
  <Image align="center" className="border" border={true} src="https://files.readme.io/432901f367c640b7d32797b5d5c70b3bdd27042d824ce992abd5a08ece128428-image.png" />
* either you enter the public URL of the image by selecting the `🔗` tab then entering  URL of the image

  <Image align="center" className="border" border={true} src="https://files.readme.io/f683f58fdad752e17e89f12a202956a20eb9fdff3259464e3a82e335f35f60bd-image.png" />
...
<Image alt="Expand to fill" align="center" border={true} src="https://files.readme.io/90930ce7cdf42f3083830bdd72f985867ebc4bb5e5118848ccf19a7535acc7bd-image.png">
  Expand to fill
</Image>

* Without the expand to fill, the Screen layout looks like this:

<Image align="center" className="border" border={true} src="https://files.readme.io/de06bad859a0f2e2199535a7b2307d6fc62a8d4b7c5ad9cc974fc76a09f1f1be-image.png" />

* With the expand to fill enabled, the Screen layout looks like this:

<Image align="center" className="border" border={true} src="https://files.readme.io/e4e61f2cd65af5db28f3dd7d1be7e2daf0f302d5ca99ca4989d05de206b8e37e-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/15480547d94e1749a5a062163f1ed813c1678f4ed7b9da207ac38bad3c7b2808-fit_vs_fill.gif" />
...
* In `Fit` mode, the image is resized to ensure the entire image is visible, maintaining its aspect ratio without cropping. This may leave empty spaces around the image if the frame and image have different aspect ratios
  ...
  <Image alt="Image in `Fit` mode: it is entirely visible. Depending on the ratio of the image and the size defined for the component it leaves empty space on the left & right of the image (pillar box) or on the bottom and top (letterbox)" align="center" border={true} src="https://files.readme.io/ef72e993f80238f410b856397241638d7d0ddac4e0ec181a90ac49980ab2ab81-image.png">
    Image in `Fit` mode: it is entirely visible. Depending on the ratio of the image and the size defined for the component it leaves empty space on the left & right of the image (pillar box) or on the bottom and top (letterbox)
  </Image>
...
* <Image alt="Image in Fill mode: it covers 100% of the component. Depending on the ratio of the image and size defined for the component, it will crop the image on the left and right side or on top and bottom." align="center" border={true} src="https://files.readme.io/c4b7b5e29b9c350245cc5fa084eb97b66c895bf351291f2083a3e5b0feba4508-image.png">
    Image in Fill mode: it covers 100% of the component. Depending on the ratio of the image and size defined for the component, it will crop the image on the left and right side or on top and bottom.
  </Image>
...
<Image align="center" className="border" border={true} src="https://files.readme.io/55a0c8929ccc4c02b251049e13c98dbc0080152ff42050a9946cc84eb9329730-dark_mode.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/f6d18d7787e677402d8f0b5225c942c1c1200a6b99f8629264d6effcc2430f78-image_selected.gif" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/49b0d1e9f8a564436cdf90d2deaa899c212f022d637efc6b29262c43e60be671-background.gif" />
