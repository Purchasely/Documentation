...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6de99f39765670d23bb1c4c7f70d40b9c22f079a8fac43d433e47ea88a88c10a-image.png",
        null,
        null
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ce02a4b00f490882635dc68bf81876af00fd834776c82510b5d211e6cb354928-image.png",
        null,
        ""
      ],
      "align": "center",
...
- `Id`: the default value "plan_picker_1" works fine. Only change the Id if you want to have several Plan pickers on the same Screen:
...
- **Pickers icon**
  ...
  - If you activate it, you can define 2 different images depending on the state of the picker: `unselected` / `selected`
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/8f4896bd887aae28cff3f23b0f7e959009f9ba0ec1cd5a47e6b144c990bb63f9-image.gif","",""],"align":"center","border":true}]}[/block]
  ...
  - By enabling `Text and Icon centered`, you can wrap the icon & the Texts inside button at the center of the button
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/7d4ce360420818e02feb6e0154139a152df4ed3a07c1438087be9b5446b271f0-layout2.gif","",""],"align":"center","border":true}]}[/block]
...
To give you maximum flexibility and allow you to create as many lines and font-styles as you wish, each Picker has a _collection of texts_ (ex: Promo label, Texts above button, Texts inside button etc...). [Texts](tabels) can be added inside a collection by clicking on the `+` button:

- Each collection maps a specific location

  [block:image]{"images":[{"image":["https://files.readme.io/a49afd6dc56249a5e6b08084d38709e364dab0d0e835ec26a28a38d0e554da1b-ezgif-4-5b5234ca4e.gif","",""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c4cafadf7e99a626b4e25db4d19e5d4a229871106e7b27b8acec7b3afe3cac41-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4a17e3542f69f3acdb72d7c5f43a46998689bb6eaae8cfb73593fe1527892959-cta3.gif",
        "",
        ""
      ],
      "align": "center",
