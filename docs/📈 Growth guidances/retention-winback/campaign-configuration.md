...
excerpt: >-
  ...
  placements, schedule start/end dates, tune capping parameters, select a Screen
  or A/B test, and manage campaign priority.
deprecated: false
hidden: false
metadata:
  title: ''
...
<Image align="center" border={true} src="https://files.readme.io/041da95b672929ce4eddf605022c013b89ffee90e1617472094d991735a85412-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/39f15535bfa0e07b78da0bb8dd36249eebe44661cc65c629cbf5d5d0bea21add-who.gif" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/79a76de98e475eeb7b6f87a7cf4502b584181da11166167e052555be65036a62-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/eac0d395868e99e591d7f9062d723345a35d57545e56d88ebb2b9edfb0a1e008-image.png" className="border" />

## Impression cap

Restricts the total number of times a user can see the campaign throughout its entire duration.

_Example: If set to 3, the campaign will not be displayed to a user after they have seen it three times, regardless of trigger or frequency cap settings._

<Image align="center" border={true} src="https://files.readme.io/131318f1eb1915ffaf86d87db20f74746d78bd086982a539b789fbfb986ff9cc-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/d8a6662f73141d9eb4541c10a897b8115b2d43113764eebd1e6cec850129e14e-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/89cb51ce1236cf73fdfbf059f05faf0901282576dfed1528fc3462d7ea763642-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/4b17afabacd455129049496f3408d5a87f06c5e46308b2fba51ae0082883408c-Screen_Recording_2025-03-17_at_09.15.05.gif" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/d4203fd8d566dce53a10e4907f5f25b0583b8af691da0dd4db42fad5e34d0f6f-campaigns_prioritization.gif" className="border" />

# Following campaign results

The Campaigns feature allows you to follow monetization KPIs for each campaign you create.

<Image align="center" border={true} src="https://files.readme.io/252364ade6b6fb37d613e910d2886464932fc7216e32f23bf75178d6911cae12-image.png" className="border" />
