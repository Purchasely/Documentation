...
To go further in the User journey personalization, you can also leverage [Conditional Visibility to tailor the Screen themselves based on the User profile](conditional-visibility#user-data).
