...
metadata:
  ...
  robots: index
next:
  description: In the next section, we explore how to tailor the Flow to the user insights
  pages:
    - type: basic
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4df9c83fd6752376ca7a9a5a75591cb8b8f4938ce8d137123c6203f712b55df5-quiz.gif",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/694ff0249cffd52d38e8208c2fa1e775087f1d11d542dc5f33705da96c702900-flow.gif",
        "",
        ""
      ],
      "align": "center",
...
2. **Edit the Transition logic**  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/0d2a7bfc14f53fbdcbdf51735188f2f9a6f07f61cec075abfaa609ff37829d85-audience.gif","","To create an Audience for users who selected a specific answer, simply select the Quiz (e.g.: What would you like some help with?) and then the corresponding value(s) (e.g.: stress or anxiety)"],"align":"center","border":true,"caption":"To create an Audience for users who selected a specific answer, simply select the Quiz (e.g.: What would you like some help with?) and then the corresponding value(s) (e.g.: stress or anxiety)"}]}[/block]
3. **Order the routes**  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9d45652982f1e8725a42b9eb9490a6d02be3614a6cb660e831fa6ec59971e108-flow_3.gif",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d7ccf7b48fccb704b04e3475aa966dce09b11656e563057df3bc3de4598fe75d-precommitment.gif",
        "",
        ""
      ],
      "align": "center",
