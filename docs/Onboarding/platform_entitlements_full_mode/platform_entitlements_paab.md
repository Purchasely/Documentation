...
next:
  description: ''
---
# What are the risks of managing the entitlements without a backend?

It is less secured than checking with your server.  
...
# What are the usage limitations associated with the User Subscription API?

This approach can only be used if  
