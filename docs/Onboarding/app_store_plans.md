...
2. Navigate to the following section:\
   *App Store Connect > My Apps >[YOUR APP] > In-App Purchase >*
3. Copy the value of the PRODUCT ID

<Image align="center" className="border" border={true} src="https://files.readme.io/8d593af-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/a77c016-image.png" />
...
<Image align="center" className="border" width="500px" border={true} src="https://files.readme.io/ead0c3e-image.png" />
...
<Image align="center" className="border" width="500px" border={true} src="https://files.readme.io/e5212eb-image.png" />
