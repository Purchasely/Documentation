...
[block:parameters]
{
  "data": {
    ...
    "5-0": "`PLAN_SELECTED`",
    "5-1": "The user selected a Plan on the Screen  \n_Deprecated with SDK versions 5.0+ => replaced by OPTIONS_SELECTED_ ",
    ...
    "14-0": "`OPTIONS_SELECTED`",
    "14-1": "The users picks up an option in a survey or selects an option or a plan in a Picker  \n_(>= SDK v5.0)_",
    "14-2": "`.optionsSelected`/`OptionsSelected\\`",
    "15-0": "`OPTIONS_VALIDATED`",
    "15-1": "The user answers a survey  \n_(>= SDK v5.0)_",
    "15-2": "`.optionsValidated` / `OptionsValidated`",
    "16-0": "",
    "17-0": "`WEB_CHECKOUT_OPENED_IN_WEB_BROWSER`",
    "17-1": "The web checkout page opened in the browser",
    "17-2": "`webCheckoutOpenedInWebBrowser`",
    "18-0": "`WEB_CHECKOUT_TAPPED`",
    "18-1": "The user tapped on the web checkout button",
    "18-2": "`webCheckoutTapped`"
  },
  "cols": 3,
  "rows": 19,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "6-0": "`WEB_CHECKOUT_ERROR`",
    "6-1": "The web checkout failed",
    "6-2": "`.webCheckoutError`",
    "7-0": "`WEB_CHECKOUT_TIMED_OUT`",
    "7-1": "The web checkout timed out",
    "7-2": "`webCheckoutTimedOut`"
  },
  "cols": 3,
  "rows": 8,
  "align": [
