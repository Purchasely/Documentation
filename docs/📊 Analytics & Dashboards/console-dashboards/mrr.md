...
>
> While MRR is computed from transaction amounts and is not directly affected by the counting change, other charts in the dashboard (such as Subscription Base Evolution and Paid Subscriptions Movements) now count subscriptions instead of subscribers. When cross-referencing MRR with those charts, keep this distinction in mind.
