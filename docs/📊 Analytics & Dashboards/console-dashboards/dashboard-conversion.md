...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ba7fe14-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/90db201-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ef57117-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ea333ec-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ee39583-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/952de0b-image.png",
        null,
        "Example of Paywalls viewed grouped by Country"
      ],
      "align": "center",
      "border": true,
      "caption": "Example of Paywalls viewed grouped by Country"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f32bb3e-image.png",
        null,
        "Example of Unique viewers grouped by Platform"
      ],
      "align": "center",
      "border": true,
      "caption": "Example of Unique viewers grouped by Platform"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6edb478-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bf0681b-image.png",
        null,
        ""
      ],
      "align": "center",
...
- _a user views a Paywall on January 1st_
- _they click on the Purchase Button_
- _and start a 1 week free trial_
- _the free trial converts on January 8th_

_=> All the conversion metrics above will be attached to the cohort of January 1st because this is the time where the user lifecycle actually started._
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7e705a0-image.png",
        null,
        "Example of conversions split by Plan"
      ],
      "align": "center",
      "border": true,
      "caption": "Example of conversions split by Plan"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/572eabe2e08f59fcfc93726da18ed0e8506fd7576ded6d40d3859e45954df070-image.png",
        null,
        null
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/547f500ce6939530d7f69c1d2e1197c0911693c36203e0ef702c2d12dac8448f-image.png",
        null,
        null
      ],
      "align": "center",
