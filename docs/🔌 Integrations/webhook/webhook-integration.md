...
next:
  description: ''
---
Comment utiliser le webhook par que pour les entitlements (déjà une page dédiée dans Quick Start à la gestion des backend-entitlements) => reusable contents à mutualiser et ou lien à mettre vers la page en question
