  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Subscription events generated by Purchasely will be sent to Iterable using a server-to-server integration."
    }
  ]
}
[/block]
...
1. Go in the "External integrations" section, and open the edition form for **Iterable**:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/7fd2970-Capture_decran_2024-07-22_a_14.53.40.png","",""],"align":"center","border":true}]}[/block]
2. Enable the integration
3. Set your **Iterable** API Key

   [block:image]{"images":[{"image":["https://files.readme.io/eff7063-Capture_decran_2024-07-22_a_14.54.01.png","",""],"align":"center","border":true}]}[/block]
...
5. (Optional) Override the names of the events that will be sent to **Iterable**
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/9782250-Capture_decran_2024-07-22_a_14.54.19.png","",""],"align":"center","border":true}]}[/block]
6. Save
