...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b3501e4-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2748cb8-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/06d8c71-image.png",
        null,
        ""
      ],
      "align": "center",
...
> ❗️ Redirects must use proper HTTP Temporary (307) / Permanent Redirect (308)
> 
> If the response is a redirection to another URL, it must be of type 
> 
> - Temporary Redirect (HTTP 307) 
> - Permanent Redirect (HTTP 308)
> 
> Redirections of type Found (HTTP 302) Moved Permanently (HTTP 301) will be rejected as they don't preserve the original request method and body