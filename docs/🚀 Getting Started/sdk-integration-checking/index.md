...
* [ ] You have filled-in the app scheme parameter in the [Purchasely Console](https://console.purchasely.io/settings?step=stores) for both iOS (tab `App Store`) and Android (tab `Play Store`)
  ...
  <Image align="center" border={true} src="https://files.readme.io/1ebfcee799479f89ce24ef8a0f9ab1be4da6f775b3044ff6ec7ed7bcab1f1a09-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/5920aa891ff42ce628a2a1c4b99026d17f8e4a3ae684706b64af349ea6ede9d8-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/c8ac543415eaaeffdf8ca3fd772ab0712d5dfa10806023d8c757a86d1cd2954a-image.png" className="border" />
...
<Image align="center" border={true} src="https://files.readme.io/0441c42c4cbe572cfac03b742b84f36f861911f7646d3e017f4d7ce3e68d0c1c-image.png" className="border" />
...
* [ ] In the [Subscriptions section of the Console](https://console.purchasely.io/subscriptions), transactions associated with an anonymous user are associated with an `anonymous ID`
  ...
  <Image align="center" border={true} src="https://files.readme.io/1b34f03b1f317daa956c37f3e2e47d6b5019082b71375ec6a801710f7d19dec4-image.png" className="border" />
...
<Image align="center" border={true} width="400px" src="https://files.readme.io/e2b7125ce2daf265bdf63d296ab6d2466cab6f565eeb2b3a31741516991e59ab-image.png" className="border" />
