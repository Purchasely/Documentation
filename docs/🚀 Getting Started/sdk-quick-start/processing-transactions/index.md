...
In `paywallObserver` mode, you manually process the transaction after intercepting the click on the purchase button thanks to the <Glossary>Paywall Action Interceptor</Glossary>.\
