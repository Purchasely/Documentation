...
| **Green line**                                                                                        | Right Y-axis | Secondary metric: a conversion rate (Overall conversion rate, Conversion rate to intro or promo offer, or Conversion rate to full price). Conversions are not attributed to the date they occur, but to the date the user last viewed a paywall |
