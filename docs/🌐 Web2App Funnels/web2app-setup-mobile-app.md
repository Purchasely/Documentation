...
Open **Web2App → Setup**, section *3. Verify your mobile app setup*: `https://console.purchasely.io/web2app?tab=setup`.
...
<Image align="center" border={true} src="TODO-NICO-UPLOAD/setup-mobile-01-sdk-version-to-confirm.webp" alt="Web2App setup, step 3.1: SDK versions detected per platform over the last 28 days, waiting for confirmation" />
...
<Image align="center" border={true} src="TODO-NICO-UPLOAD/setup-mobile-01b-sdk-version-confirmed.png" alt="Web2App setup, step 3.1: iOS platform confirmed while most app starts still run an older SDK" />
...
<Image align="center" border={true} src="TODO-NICO-UPLOAD/setup-mobile-02-app-scheme.png" alt="Web2App setup, step 3.2: app scheme per platform" />
...
<Image align="center" border={true} src="TODO-NICO-UPLOAD/setup-mobile-03-icon-favicon.png" alt="Web2App setup, step 3.3: app icon and favicon" />
...
| --- | --- |
| The step shows *Not detected* for a platform. | Your app has not sent events for that platform in the last 28 days. Check the SDK initialization, or ignore the platform if you do not ship on it. |
