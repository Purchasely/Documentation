...
Open **Web2App → Setup**, section *4. External integrations*. Each platform is also available under **App settings → Integrations**, where the same screen opens.

<Image align="center" border={true} src="TODO-NICO-UPLOAD/setup-ads-01-section-external-integrations.png" alt="Web2App setup, section 4. External integrations with the four ad platforms" />
