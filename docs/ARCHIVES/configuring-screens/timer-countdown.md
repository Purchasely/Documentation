...
<Image align="center" className="border" border={true} src="https://files.readme.io/54d3fb5-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/3cc87fc-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/58f5750-image.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/7ddbadd-image.png" />

Here is how it works.

<Image align="center" className="border" border={true} src="https://files.readme.io/f1acf1a-image.png" />
...
4. Choose Absolute countdown
   ...
   <Image align="center" className="border" border={true} src="https://files.readme.io/ddf704a-image.png" />
5. Set the desired `Countdown date` (with the `hour`), `timezone` and choose the format `DD:hh:mm:ss`

   <Image align="center" className="border" border={true} src="https://files.readme.io/97965f9-image.png" />
6. Click on the `OK` button
7. The tags associated to your date appear in the field

<Image align="center" className="border" border={true} src="https://files.readme.io/9d46926-image.png" />
...
* Only keep the matching tag\
  *E.g.:`TIMER(HOURS)` for the field `DIGITAL HOURS` and remove the remaining text*

  <Image align="center" className="border" border={true} src="https://files.readme.io/060e405-image.png" />
...
1. Create the Custom User Attribute in the Purchasely Console
   ...
   <Image align="center" className="border" border={true} src="https://files.readme.io/0b22066-image.png" />
...
2. Create a new Paywall and integrate a User countdown leveraging this attribute
   ...
   <Image alt="The `Countdown in seconds` will be added to the date contained in the User Attribute. To configure 3 days following the sign-up date, we therefore set a Countdown of 259200 seconds (3 days in seconds)" align="center" border={true} src="https://files.readme.io/136d098-image.png">
     The `Countdown in seconds` will be added to the date contained in the User Attribute. To configure 3 days following the sign-up date, we therefore set a Countdown of 259200 seconds (3 days in seconds)
   </Image>

<Image alt="Note: the User countdown might not display dynamically in the Preview (it will in the App)" align="center" border={true} src="https://files.readme.io/2c235af-image.png">
...
3. Create an Audience to define the conditions under which the Paywall must be displayed
   ...
   1. **Case 1: Custom Attribute set by the app code**\
      ...
      <Image alt="Users will belong to this Audience only if their sign-up date was less than 4 days ago. In other words, during the 3 days following their sign-up date" align="center" border={true} src="https://files.readme.io/422b236-image.png">
   ...
   2. **Case 2: Custom Attribute automatically set when the Paywall is displayed for the first time**\
      ...
      <Image alt="For all the Users, the attribute `promotion Start Date`  is initially not set. Therefore, they will match the Audience and see the associated Paywall. Once they see it, the Paywall automatically sets the attribute to the current date and hour - `now()`. Then, they will match the Audience for the 3 following days and will stop matching it (and thus access the Paywall) once the countdown is finished." align="center" border={true} src="https://files.readme.io/c21ab55-image.png">
        For all the Users, the attribute `promotion Start Date`  is initially not set. Therefore, they will match the Audience and see the associated Paywall. Once they see it, the Paywall automatically sets the attribute to the current date and hour - `now()`. Then, they will match the Audience for the 3 following days and will stop matching it (and thus access the Paywall) once the countdown is finished.
      </Image>
...
4. Map the Paywall and Audience on the desired Placement\
   *Users who are in the 3 days following their sign-up date will see the paywall Discount 30% following the signup Date, which integrates the User countdown of 3 days we configured above*
   ...
   <Image alt="This Placement is automatically called by the app at the app launch. As it is associated to NONE for the Audience Everyone else, users which are not concerned by a promotion will not see any Paywall. " align="center" src="https://files.readme.io/3129339-image.png">
