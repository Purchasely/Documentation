...
From the Purchasely package window (_Windows -> Purchasely_):
...
Got to _Assets → Import package → Custom package_  
Find and add **external-dependency-manager-latest.unitypackage**  
from ​<https://github.com/googlesamples/unity-jar-resolver>
