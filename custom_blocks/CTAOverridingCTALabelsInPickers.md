...
* This Text is overridden for each picker: 
  ...
  * "Start my **yearly** membership" for the Picker associated to the Yearly Plan
    ...
    <Image align="center" className="border" border={true} src="https://files.readme.io/845cfeb066c30d512d2707803e55f2051e87b9a686c677ef1068d9032c95123a-ezgif-3-edb54ad6cd.gif" />
