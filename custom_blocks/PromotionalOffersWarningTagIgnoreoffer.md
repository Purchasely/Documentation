...
> 
> [block:image]{"images":[{"image":["https://files.readme.io/893c73e-image.png",null,""],"align":"center","border":true,"caption":"For developers determined offers, add the `ignore-offer` tag to avoid having the offer proposed to everyone\n\n"}]}[/block]
> 
